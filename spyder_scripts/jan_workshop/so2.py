...
CodonTable['GGG'] = 'G'
CodonTable['UAA'] = 'Stop'  # question 1

print len(CodonTable) # question 2

RNAs.extend(['AAC','GAA']) # question 3

print CodonTable[RNAs[0]]
print CodonTable[RNAs[2]]
print CodonTable[RNAs[5]] # question 4
